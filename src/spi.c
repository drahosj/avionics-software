...
static volatile uint8_t SPI1_DMA_RX_Semaphore = 0;
...
int16_t SPI1_Transfer(uint8_t * txBuffer, uint8_t * rxBuffer, uint16_t length)
{
    SPI1_DMA_RX_Semaphore = 0;
    ...
    while (SPI1_DMA_RX_Semaphore == 0) {} /* Delay for interrupt */
